...
void UpdateMouseScroll(GLFWwindow* window, double xOffset, double yOffset);
void getPosition();
...
int main(int argc, char* argv[]) {
	...
	camPos = glm::vec3(3.f, 0.0f, 10.f);
	camFront = glm::vec3(-3.f, 0.0f, -10.0f);
...
void Render() {
	...
	//glm::mat4 view = glm::lookAt(glm::vec3(camX, 2.0f, camZ), camFront, camUp);
	...
	cylinderModel = glm::translate(cylinderModel, glm::vec3(0.0f, -1.f, 0.f));
...
// UpdateKeyboardInput: Callback for keyboard input
// ---------------------------------------------
void UpdateKeyboardInput() {
	glfwPollEvents();

	if (glfwGetKey(window, GLFW_KEY_W) == GLFW_PRESS)
		camPos.z += deltaTime * cameraSpeed;
	if (glfwGetKey(window, GLFW_KEY_S) == GLFW_PRESS)
		camPos.z -= deltaTime * cameraSpeed;
	if (glfwGetKey(window, GLFW_KEY_A) == GLFW_PRESS)
		camPos.x -= deltaTime * cameraSpeed;
	if (glfwGetKey(window, GLFW_KEY_D) == GLFW_PRESS)
		camPos.x += deltaTime * cameraSpeed;
	if (glfwGetKey(window, GLFW_KEY_Q) == GLFW_PRESS)
		camPos.y -= deltaTime * cameraSpeed;
...
// UpdateMouseInput: Updates the position of the camera
// ---------------------------------------------
void UpdateMouseInput() {

}

// UpdateMouseScroll: Updates camera speed
// ---------------------------------------------
void UpdateMouseScroll(GLFWwindow* window, double xOffset, double yOffset) {
	if (yOffset < 0.0) {
		cameraSpeed -= 0.1;
	...
	std::cout << "Scroll Speed: " << cameraSpeed << std::endl;
}